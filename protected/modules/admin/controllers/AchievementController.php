...
{
    public $h1 = 'Достижения';
    public $h1_edit = 'Редактирование достижения';
    public $title = 'Достижения';
    public $model_name = 'Achievement';
    ...
    public function actionUpdate($id = 0)
    {
        ...
        if (0 != $id) {
            $this->breadcrumbs[$model->text_ru] = array('view', 'id' => $model->primaryKey);
        }
