...
class Category extends CActiveRecord
{
    ...
    function parentChildSort_r($id_field, $parent_field, $name_field, $array, $parent_id = 0, &$result = array(), &$depth = 0)
    {
        foreach ($array as $key => $value) {
            if ($value[$parent_field] == $parent_id) {
                ...
                $depth++;
                $this->parentChildSort_r($id_field, $parent_field, $name_field, $array, $parent_id, $result, $depth);
                $parent_id = $oldParent;
                $depth--;
            }
        }
